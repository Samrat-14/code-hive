  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`group relative flex items-center gap-3 px-2 sm:px-4 py-2 bg-[#1e1e2e]/80 
      ...
      >
        ...
        <div className="size-4 sm:size-6 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-110 transition-transform">
          <Image
        ...
        <span className="hidden sm:inline-block text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors">
          {currentLanguageObj.label}
        </span>

        <ChevronDownIcon
          className={`hidden sm:inline-block size-4 text-gray-400 transition-all duration-300 group-hover:text-gray-300
            ${isOpen ? 'rotate-180' : ''}`}
        />
      </motion.button>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-40 sm:w-64 bg-[#1e1e2e]/95 backdrop-blur-xl
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="hidden sm:inline-block flex-1 text-left group-hover:text-white transition-colors">
                        {lang.label}
                      </span>
