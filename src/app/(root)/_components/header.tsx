        ...
        <div className="hidden lg:flex items-center gap-8">
          <Link href="/" className="flex items-center gap-3 group relative">
            ...
            <div className="flex flex-col">
              <span className="block text-lg font-extrabold bg-gradient-to-r from-blue-400 via-blue-300 to-purple-400 text-transparent bg-clip-text">
                CodeHive
              </span>
          ...
          <nav className="flex items-center space-x-1">
            <Link
              href="/snippets"
              className="relative group flex items-center gap-2 px-4 py-1.5 rounded-lg text-gray-300 bg-gray-800/50 hover:bg-blue-500/10 border-gray-800 hover:border-blue-500/50 transition-all duration-300 shadow-lg overflow-hidden"
            >
        ...
        <div className="flex items-center gap-4">
          ...
          {!convexUser?.isPro && (
            ...
            >
              ...
              <span className="textr-sm font-medium text-amber-400/90 hover:text-amber-300">Pro</span>
            </Link>
          )}
