  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="group relative flex items-center gap-2 px-2 sm:px-4 py-2 bg-[#1e1e2e]/80 hover:bg-[#262637] 
      ...
      >
        ...
        <span className="hidden sm:inline-block text-gray-300 min-w-[80px] text-left group-hover:text-white transition-colors">
          {currentTheme?.label}
        </span>

        <div
          className="hidden sm:inline-block relative w-4 h-4 rounded-full border border-gray-600 group-hover:border-gray-500 transition-colors"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full min-w-[120px] sm:min-w-[240px] bg-[#1e1e2e]/95 
